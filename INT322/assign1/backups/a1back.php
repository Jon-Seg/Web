...
<div class="button">
	<table class="left"><tr>
	<td><p class="title2">Add stock to inventory  /  View store inventory:</p></td>
	<td><a href="http://zenit.senecac.on.ca/~int322_162a28/assign1/a1.php?" class="button2">Add</a></td>
...
<table class="right"><tr>
	...
	<td><a href="http://zenit.senecac.on.ca/~int322_162a28/assign1/a1.php?" class="button2">Reset</a></td>
	<td><p class="title3">Submit form data  /  Cancel form data:</p></td>
	</tr>
	</table>
</div>
		</form>
